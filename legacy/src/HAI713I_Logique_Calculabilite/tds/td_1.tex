...
% ----- Consignes exo 3 ----- %
\begin{td-exo}[\(\text{Step}\), convergence, projections et énumération] % 3
...
\begin{td-exo}[Ensembles énumérables --- mieux comprendre]\ % 5
	\begin{enumerate}
		...
		si et seulement si il admet une fonction d'énumération croissante.

		\item Soit \(E\) un ensemble infini. Montrez que \(E\) est récursif
		si et seulement si il admet une fonction d'énumération strictement croissante.
	\end{enumerate}
\end{td-exo}
