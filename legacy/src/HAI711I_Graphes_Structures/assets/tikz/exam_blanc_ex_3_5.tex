\ffigbox[\FBwidth]{%
\caption{\centering Graphe après augmentation du chemin par \(ae-eb-bcfijq\)}\label{Fig:exam_blanc_ex_3_5}
}{
    \fbox{
        \begin{tikzpicture}[scale=1, main node/.style={circle, draw, fill=blue!20, inner sep=1pt, font=\scriptsize, minimum size=6mm}]
            ...
            \node[main node] (cfijq) at (1,0) {\(cfijq\)};
            ...
            % les aretes
            \draw[] (a) -- (b);
            \draw[draw=red, thick] (a) -- (e);
            \draw[] (a) -- (h);

            \draw[] (b) -- (e);
            \draw[draw=red, thick] (b) -- (cfijq);
