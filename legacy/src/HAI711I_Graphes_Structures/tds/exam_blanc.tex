...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\,\\ % 1
        ...
        \begin{figure}[H]
            \CenterFloatBoxes{}
            \begin{floatrow}
                \input{../assets/tikz/exam_blanc_ex_1_2_a.tex}

                \input{../assets/tikz/exam_blanc_ex_1_2_b.tex}
            \end{floatrow}
        \end{figure}
		...
		\begin{figure}[H]
            \CenterFloatBoxes{}
            \begin{floatrow}
                \input{../assets/tikz/exam_blanc_ex_1_3_a.tex}

                \input{../assets/tikz/exam_blanc_ex_1_3_b.tex}
            \end{floatrow}
        \end{figure}
        ...
        \begin{figure}[H]
            \CenterFloatBoxes{}
            \begin{floatrow}
                \input{../assets/tikz/exam_blanc_ex_1_4_a.tex}

                \input{../assets/tikz/exam_blanc_ex_1_4_b.tex}
            \end{floatrow}
        \end{figure}
...
\begin{td-exo}[Indépendant dans les subcubiques --- 5pts]\,\\ % 2
    Un graphe \(G = (V,E)\) est dit \defemph{subcubique} si tous ses sommets ont degré au plus 3, c'est à dire si \(\forall v\in V, \mathsf{deg}_G(v) \leq 3\). % chktex 35
    ...
    \begin{enumerate}
        ...
        \item On suppose maintenant que \(G\) est cubique (c'est à dire \(\forall v\in V, \mathsf{deg}_G(v) = 3\)) et on va établir une borne supérieure pour \(\alpha(G)\). % chktex 35
        \begin{enumerate}
	...
	\begin{td-sol}[]\, % 5
		\begin{enumerate}
            ...
            \begin{figure}[H]
                \CenterFloatBoxes{}
                \begin{floatrow}
                    \input{../assets/tikz/exam_blanc_ex_5_1_a.tex}

                    \input{../assets/tikz/exam_blanc_ex_5_1_b.tex}
                \end{floatrow}
            \end{figure}
            ...
            \begin{figure}[H]
                \CenterFloatBoxes{}
                \begin{floatrow}
                    \input{../assets/tikz/exam_blanc_ex_5_2_a.tex}

                    \input{../assets/tikz/exam_blanc_ex_5_2_b.tex}
                \end{floatrow}
            \end{figure}
