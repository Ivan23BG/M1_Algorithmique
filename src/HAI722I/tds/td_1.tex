...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\ %
		\begin{enumerate}
			...
			\begin{equation*}
				S = \left\{ x \in \bb R \mid x = \sum_{i=1}^n \frac{1}{2^i}, n \in \bb N \right\} = \left\{ 0, \frac{1}{2}, \frac{1}{4}, \frac{3}{4}, \ldots \right\}
			\end{equation*}
			vérifie la propriété de demi-somme mais n'est pas convexe, car par exemple \(\sqrt{2}/2 \in [0,1] \notin S\).
		\end{enumerate}
	\end{td-sol}
}{}
