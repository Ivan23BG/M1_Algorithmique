...
\begin{td-exo}[Flots --- 3pts]\,\\ % 1
    ...
    \vspace{0.2cm}
    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_1.pdf}
\end{td-exo}
...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\,\\ % 1
        ...
        \begin{figure}[H]
            ...
            \begin{floatrow}
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_2_a.pdf}

                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_2_b.pdf}
            \end{floatrow}
        \end{figure}
		...
		\begin{figure}[H]
            \CenterFloatBoxes{}		% centers the floatrow contents horizontally
            \begin{floatrow}
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_3_a.pdf}

                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_3_b.pdf}
            \end{floatrow}
        \end{figure}
        ...
        \begin{figure}[H]
            \CenterFloatBoxes{}		% centers the floatrow contents horizontally
            \begin{floatrow}
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_4_a.pdf}

                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_4_b.pdf}
            \end{floatrow}
        \end{figure}
        ...
        \begin{figure}[H]
            \CenterFloatBoxes{}		% centers the floatrow contents horizontally
            \begin{floatrow}
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_5_a.pdf}

                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_1_5_b.pdf}
            \end{floatrow}
        \end{figure}
	...
	\begin{td-sol}[]\, % 2
		\begin{enumerate}
            ...
            \begin{itemize}
                ...
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_2_1.pdf}
                ...
                \vspace{0.2cm}
                \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_2_2.pdf}
...
\begin{td-exo}[Couplage max --- 3pts]\,\\ % 3
    ...
    \vspace{0.2cm}
    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_1.pdf}
\end{td-exo}
...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\,\\ % 3   
        ...
        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_2.pdf}

        Contractons maintenant des blossoms. On peut commencer par le blossom \(cfi\):

        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_3.pdf}

        Ensuite on peut contracter le blossom \(cfijq\):

        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_4.pdf}
        ...
        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_5.pdf}
        ...
        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_6.pdf}

        Enfin, on décontracte le blossom \(cfi\) pour obtenir le couplage maximum final:
        
        \vspace{0.2cm}
        \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_3_7.pdf}
...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\, % 4
		\begin{enumerate}
            ...
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_1.pdf}
            ...
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_2.pdf}
            ...
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_3.pdf}
            ...
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_4.pdf}

            Ensuite pour \(E_2\):

            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_5.pdf}

            Et pour \(E_2'\):

            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_6.pdf}

            Enfin pour \(E_3\):

            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_7.pdf}

            Et pour \(E_3'\):

            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_4_8.pdf}
	...
	\begin{td-sol}[]\, % 5
		\begin{enumerate}
            ...
            \begin{figure}[H]
                \CenterFloatBoxes{}		% centers the floatrow contents horizontally
                \begin{floatrow}
                    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_1_a.pdf}

                    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_1_b.pdf}
                \end{floatrow}
            \end{figure}
            ...
            \begin{figure}[H]
                \CenterFloatBoxes{}		% centers the floatrow contents horizontally
                \begin{floatrow}
                    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_2_a.pdf}

                    \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_2_b.pdf}
                \end{floatrow}
            \end{figure}
            ...
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_3.pdf}

            Observons ce qui se passe quand on passe au complémentaire \(\ol{G'}\):

            % TODO: replace by the correct figure
            \vspace{0.2cm}
            \includegraphics{../../../pdfs/HAI711I_Graphes_Structures/figures/exam_blanc_ex_5_4.pdf}

            On remarque alors que les arêtes internes à \(G\) ne posent pas de soucis car 
            \(G\) est auto-complémentaire. De même pour les arêtes internes à \(P\).
            Reste à vérifier que les arêtes entre \(G\) et \(P\) sont bien préservées par l'isomorphisme.
            Dans \(G'\), les sommets \(p_1\) et \(p_4\) sont reliés à tous les sommets de \(G\).
            Dans \(\ol{G'}\), les sommets \(p_2\) et \(p_3\) sont reliés à tous les sommets de \(\ol{G}\).
            Comme \(G\) est isomorphe à \(\ol{G}\), on peut définir un isomorphisme entre \(G'\) et \(\ol{G'}\) en envoyant \(p_1\) sur \(p_2\), \(p_4\) sur \(p_3\) et en utilisant l'isomorphisme entre \(G\) et \(\ol{G}\) pour les autres sommets.
            ...
            \begin{equation*}
                ...
                \begin{cases}
                    ...
                    p_3 \mapsto g_n\\
                    p_4 \mapsto p_3\\
                    g_i \mapsto f_G(g_i) & \text{ pour } i = 1, \ldots, n
                \end{cases}
            \end{equation*}
            où \(f_G\) est un isomorphisme entre \(G\) et \(\ol{G}\).

            Ainsi, \(G'\) est auto-complémentaire.
