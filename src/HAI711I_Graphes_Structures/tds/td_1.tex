...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\,\\ %
		...
		\begin{itemize}
			...
			\vspace{0.1cm}
			\input{../assets/tikz/td_1_ex_1_case1.tex}
	...
	\begin{td-sol}[]\, %
		\begin{enumerate}
			...
			\begin{figure}[H]
				...
				\begin{floatrow}
					\input{../assets/tikz/td_1_ex_2_q1_a.tex}

					\input{../assets/tikz/td_1_ex_2_q1_b.tex}

					\input{../assets/tikz/td_1_ex_2_q1_c.tex}
				\end{floatrow}
			\end{figure}
			...
			\begin{figure}[H]
				\CenterFloatBoxes{}		% centers the floatrow contents horizontally
				\begin{floatrow}
					\input{../assets/tikz/td_1_ex_2_q1_d.tex}
				\end{floatrow}
			\end{figure}
			...
			\begin{figure}[H]
				\CenterFloatBoxes{}
				\begin{floatrow}
					\input{../assets/tikz/td_1_ex_2_q2_a.tex}

					\input{../assets/tikz/td_1_ex_2_q2_b.tex}
				\end{floatrow}
			\end{figure}
			...
			\begin{figure}[H]
				\CenterFloatBoxes{}
				\begin{floatrow}
					\input{../assets/tikz/td_1_ex_2_q2_c.tex}

					\input{../assets/tikz/td_1_ex_2_q2_d.tex}
				\end{floatrow}
			\end{figure}
			...
			\begin{figure}[H]
				\CenterFloatBoxes{}
				\begin{floatrow}
					\input{../assets/tikz/td_1_ex_2_q3_a.tex}

					\input{../assets/tikz/td_1_ex_2_q3_b.tex}
				\end{floatrow}
			\end{figure}
		\end{enumerate}
	\end{td-sol}
