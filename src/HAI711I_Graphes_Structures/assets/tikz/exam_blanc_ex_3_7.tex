\ffigbox[\FBwidth]{%
\caption{\centering Graphe final après décontraction du blossom \(cfi\)}\label{Fig:exam_blanc_ex_3_7}
}{
    \fbox{
        \begin{tikzpicture}[scale=1, main node/.style={circle, draw, fill=blue!20, inner sep=1pt, font=\scriptsize, minimum size=6mm}]
            ...
            \draw[] (b) -- (e);
            \draw[draw=blue, thick] (b) -- (i);

            \draw[draw=red, thick] (c) -- (f);
            \draw[] (c) -- (i);
            \draw[] (e) -- (h);
