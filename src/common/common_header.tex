...
\usetikzlibrary{positioning, shapes, arrows.meta, external}        % Arrow tips for TikZ diagrams
...
% =========================================================
% LIGHT / DARK MODE TOGGLE — single switch
% =========================================================

% ---------- TOGGLE ----------
\newif\ifdarkmode    % chktex 1
% \darkmodetrue      % comment this line for LIGHT mode % chktex 1
% \darkmodefalse     % or uncomment this % chktex 1

% ---------- COLORS ----------
\ifdarkmode          % chktex 1
    % Page
    \definecolor{pagebg}{RGB}{18,18,18}
    \definecolor{pagetext}{RGB}{220,220,220}
    ...
    % Theorems
    \definecolor{theorembg}{RGB}{28,28,28}
