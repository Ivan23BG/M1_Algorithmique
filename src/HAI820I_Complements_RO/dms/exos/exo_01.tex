		...
		\begin{enumerate}
            ...
            \begin{itemize}
                ...
                \begin{equation*}
                    (0, 0), (0, 4/3), (5, 3)
                \end{equation*}
                \item Ici on pourrait aussi considérer les points \((6.5, 3), (6.5, 0)\) mais ils ne correspondent qu'aux bornes de la figure si on se rajoute la contrainte \(x_1 \leq 6.5\).
                Ce n'est fait dans la figure~\ref{fig:dm1_ex01_f1} que pour mieux visualiser le polyèdre, mais ce n'est pas une contrainte du problème \(P_\varepsilon\).
            \end{itemize}
