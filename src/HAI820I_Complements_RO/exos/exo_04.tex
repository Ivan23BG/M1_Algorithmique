...
\iftoggle{showsolutions}{ 
	\begin{td-sol}[]\ % 4
		\begin{enumerate}
			...
			\input{../assets/tikz/td1_ex04_f1.tex}

			\item L'arbre de branchement sur \(x_1\) est le suivant:

			\input{../assets/tikz/td1_ex04_f2.tex}
			
			\item Le premier branchement sur la variable \(x_2\) correspond à la séparation de l'espace des solutions en deux parties par les deux demi-espaces \(x_2 \leq 1\) et \(x_2 \geq 2\). 
			Si on représente graphiquement le programme linéaire en nombres entiers \(PL_0\), cela donne:

			\input{../assets/tikz/td1_ex04_f3.tex}
		\end{enumerate}
