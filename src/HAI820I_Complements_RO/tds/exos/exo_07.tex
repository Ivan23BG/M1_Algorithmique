	...
	\begin{td-sol}[]\ % 7
		\begin{enumerate}
			...
			\begin{itemize}
				...
				\item \(v-u\) de poids \(2\),
			\end{itemize}
			Le poids total de l'ACPM est \(7\).

			On reconnecte \(x\) au graphe par les 2 arêtes les moins cheres pour un poids total de \(7+6=13\).

			Le degré de \(t\) est 3 donc on branche sur \(t\).

			Si on retire \(ty\) du graphe, le nouvel ACPM devient
