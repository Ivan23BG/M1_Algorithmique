\vspace{2mm}
\ffigbox[\FBwidth]{%
\caption{\centering Représentation du problème \(PL_0\) avec les contraintes \(x_1 \leq 3\) et \(x_2 \geq 1\)}\label{fig:dm1_ex04_f4}
}{
    \fbox{
        \begin{tikzpicture}
            \begin{axis}[
            ...
            \addplot[dashed, thick, yellow, domain=0:4] {19/3 - 2*x};
            \addlegendentry{Ligne de niveau \(z=19/3\)}
            \end{axis}
        \end{tikzpicture}
    }
}