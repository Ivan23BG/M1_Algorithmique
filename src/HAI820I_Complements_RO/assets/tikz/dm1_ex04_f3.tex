\vspace{2mm}
\ffigbox[\FBwidth]{%
\caption{\centering Représentation du problème \(PL_0\) avec les contraintes \(x_1 \leq 3\) et \(x_2 \leq 0\)}\label{fig:dm1_ex04_f3}
}{
    \fbox{
        \begin{tikzpicture}
            \begin{axis}[
            ...
            % x2 = 0
            \addplot[domain=0:4, very thick, color=red] {0};
