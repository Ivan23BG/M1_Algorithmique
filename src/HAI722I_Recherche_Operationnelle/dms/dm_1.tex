...
\begin{td-sol}[]\ %
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \item[\eqref{C4}] les variables sont binaires
        \end{itemize}

        \item Pour obtenir la formulation du dual, on relâche la contrainte de binarité sur les variables \(x_{ij}\). On introduit les variables duales \(u_i\) (une par job) et \(v_j\) (une par travailleur). Le dual s'écrit alors:
        ...
        \begin{itemize}
            ...
            \item[\eqref{D3}] les variables duales associées aux inégalités sont positives
        \end{itemize}
