...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\ %
		Soit \(M\) une matrice triangulaire. On peut supposer 
		sans perte de généralité que \(M\) est triangulaire supérieure (en 
		effet, le déterminant d'une matrice est le même que celui de sa 
		transposée). Alors \(M\) s'écrit:
		\begin{equation*}
			\begin{pmatrix}
				m_{1,1} & m_{1,2} & m_{1,3} & \cdots & m_{1,n}\\
				0 & m_{2,2} & m_{2,3} & \cdots & m_{2,n}\\
				0 & 0 & m_{3,3} & \cdots & m_{3,n}\\
				\vdots & \vdots & \vdots & \ddots & \vdots\\
				0 & 0 & 0 & \cdots & m_{n,n}
			\end{pmatrix}
		\end{equation*}
		On peut développer le calcul du déterminant:
		\begin{equation*}
			\begin{aligned}
				\det(M)
				&= m_{1,1} \det\begin{pmatrix}
					m_{2,2} & m_{2,3} & \cdots & m_{2,n}\\
					0 & m_{3,3} & \cdots & m_{3,n}\\
					\vdots & \vdots & \ddots & \vdots\\
					0 & 0 & \cdots & m_{n,n}
				\end{pmatrix}
			\end{aligned}
		\end{equation*}
		En faisant une simple récurrence, on trouve:
		\begin{equation*}
			\det(M) = m_{1,1} \times m_{2,2} \times m_{3,3} \times \cdots \times m_{n,n} = \prod_{i=1}^{n} m_{i,i}.
		\end{equation*}
		c'est-à-dire le produit des entrées diagonales.
\end{td-sol}
}{}
...
\iftoggle{showsolutions}{
	\begin{td-sol}[]\ %
		Appliquons le pivot de Gauss aux matrices \(A\) et \(B\).
		\begin{enumerate}
			\item Pour \(A\), on a:
			\begin{equation*}
				\begin{aligned}
					\left(\begin{array}{ccc|ccc} % chktex 44
						1 & 1 & 2 & 1 & 0 & 0\\
						1 & 2 & 1 & 0 & 1 & 0\\
						2 & 1 & 1 & 0 & 0 & 1
					\end{array}\right)
					...
					\left(\begin{array}{ccc|ccc} % chktex 44
						...
						0 & 0 & -4 & -3 & 1 & 1
					\end{array}\right)\\
					&\xrightarrow{L_3 \leftarrow -\frac14 L_3}&&
					\left(\begin{array}{ccc|ccc} % chktex 44
						1 & 1 & 2 & 1 & 0 & 0\\
						0 & 1 & -1 & -1 & 1 & 0\\
